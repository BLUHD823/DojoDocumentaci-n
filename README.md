...
## Funcion
Esta funcion se encarga de encender y apagar el sonido, el tiempo deseado

SONIDO son #define que utilizamos para agregar el buzzer, asociandolo a un pine de la placa arduino.
...
- [Link GDB](https://onlinegdb.com/-Ap8x9toM)
